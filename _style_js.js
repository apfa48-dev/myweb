var myTheme = {
	...
	isIn : function(){
		if (typeof(document.domain)=="string") {
			if (document.domain.match(".madrid.org$")) return true;
		}
		return false;
	},
	getFooter : function(){
		if (this.isInIframe()) this.footer = false;
		if (!this.isIn()) this.footer = false;
		if (this.footer==true) {
			$("body").addClass("emOnline");
			if ($("#made-with-eXe").length==1) $("body").addClass("emMadeWithExe");
			$("#content").append('<div id="emCommonFooter"></div>');
			emCommonToolsOptions={cookies:false,footer:true}			
			var t=new Date();var d=t.getDate();var m=t.getMonth()+1;var y=t.getFullYear();if(d<10)d="0"+d;if(m<10)m="0"+m;t=y+m+d+t.getHours()+(t.getMinutes()>29?2:1);var s=document.createElement("script");s.type="text/javascript";s.src="https://avisos.educa.madrid.org/public/news/js/common.js?v="+t;var h=document.getElementsByTagName("head");if(h.length>0)h[0].appendChild(s)
		}
	},
	isMobile : function(){
		try {
